package com.blogspot.rizqiulhusna.app12141439;

import java.util.Scanner;

public class app12141439 {
    String nama;
    byte level = 1;
    byte kesempatan = 5;
    short tebak;
    ...
    public void Score() {
        ...
        System.out.println("Jessica\t: 50");
        System.out.println("Mark\t: 50");
        System.out.println("Krystal\t: 100");
        System.out.println("Rain\t: 70");
    }
    
    public static void main(String[] args) {
        app12141439 main = new app12141439();
        
        main.random = (short) (Math.random()*main.Level());
        System.out.println("Masukkan nama Anda untuk memulai atau tekan 'T' untuk keluar.");
